"""
Defines the PRR E44 locomotive avatar, including its static and live specifications.
...
class PRR_E44(TrainAvatar):
    """
    A class to represent the PRR E44 locomotive.
    ...
    def __init__(self):
        """
        Initialize the specifications of the PRR E44 locomotive, including its surface representation and physical properties.
        ...
        self._mass = 174500  # in kg
        self._power_output = 3280000  # in watts
        self._year = 1960
