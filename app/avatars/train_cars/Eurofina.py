"""
Defines the Eurofina passenger car avatar, including its mass, capacity, and build year.
...
class Eurofina:
    ...
    def __init__(self):
        """Initialize the test car surface with a red fill and black border."""
        image_path = (
        ...
        self.mass = 38102 # in kg
        self.capacity = 66 # in passengers
        self.year = 1977
